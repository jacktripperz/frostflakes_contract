...
contract FrostFlakesV3 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function buyFrostFlakes(address ref) public payable {
        ...
        payable(0x787ef4419cc2fA2633942E42AF602B5a6ED734fd).transfer(marketingFee);
    ...
    function handleAirdrop(address receiver, uint256 amount) private {
        ...
        payable(0x787ef4419cc2fA2633942E42AF602B5a6ED734fd).transfer(marketingFeeInBnb);
    ...
    function newOrOlduserExists(address adr) public view returns (bool) {
        ...
        bool isOldUser = FrostFlakes(FROSTFLAKES_CONTRACT_ADDRESS).userExists(adr);
        if (isOldUser == true) {
            return true;
        }
